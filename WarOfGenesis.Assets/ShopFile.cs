...
/// <c>0x0c</c> 부터 <b>파는 아이템 번호 15칸</b>(0 은 빈 칸) — 여기까지 42바이트다.
/// 노트는 파일이 42바이트라고 적었지만 실제 파일은 33개 중 28개가 <b>44바이트</b>고 마지막 워드에 1188~8297 쯤 되는 값이 더 붙어 있다
/// (낱장 <c>Shp\0008.shp</c> 도 44바이트다). 그 워드의 뜻은 아직 모른다 — 읽는 칸은 다 42바이트 안이라 값은 그대로다.
